package com.github.ivankornienko31.randomapplication.presentation.screens.greeting
...
import randomapplication.composeapp.generated.resources.greeting_button_action
import randomapplication.composeapp.generated.resources.greeting_screen_dream
import randomapplication.composeapp.generated.resources.greeting_screen_greeting
import randomapplication.composeapp.generated.resources.greeting_screen_nice
import randomapplication.composeapp.generated.resources.greeting_screen_picture_description
 ...
 * @param navigateToLogin Callback для навигации к экрану [com.github.ivankornienko31.randomapplication.presentation.screens.login.LoginScreen]*/
...
/**
 * Превью для свёрстанного экрана [com.github.ivankornienko31.randomapplication.presentation.screens.greeting.GreetingScreen].
 *
 * По умолчанию стоит английская локаль, также показывается фон приложения.
 *
 * [com.github.ivankornienko31.randomapplication.presentation.screens.greeting.GreetingScreen] обернут в [com.github.ivankornienko31.randomapplication.presentation.themes.RandomAppTheme], чтобы применить цветовую палитру.
 *
 * @author Иван Корниенко*/
