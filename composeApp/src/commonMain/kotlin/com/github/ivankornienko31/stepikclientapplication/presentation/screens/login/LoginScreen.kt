...
import com.github.ivankornienko31.stepikclientapplication.presentation.themes.CustomShapes
 ...
 *
 * В функции [LoginScreen] добавлено логирование, срабатывающее при получении данных из `Composable` [com.github.ivankornienko31.stepikclientapplication.presentation.screens.greeting.GreetingScreen]
 *
 * @param id Значение, которое передается при надатии на кнопку в экране [com.github.ivankornienko31.stepikclientapplication.presentation.screens.greeting.GreetingScreen]
 ...
 *
 * Общие `Composables`:
 * - [com.github.ivankornienko31.stepikclientapplication.presentation.screens.login.EmailTextField] - поле ввода для email
 * - [com.github.ivankornienko31.stepikclientapplication.presentation.screens.login.PasswordTextField] - поле ввода для пароля
 * - [com.github.ivankornienko31.stepikclientapplication.presentation.screens.login.AcceptButton] - кнодка "отправки" данных
 *
 * Дополнительные `Composables`:
 * - [CompositionLocalProvider] - необходимо для прозрачной заливки при автоподстановке данных в поля ввода
 *
...
/**
 * Превью для свёрстанного экрана [com.github.ivankornienko31.stepikclientapplication.presentation.screens.login.LoginScreen].
 *
 * По умолчанию стоит английская локаль, также показывается фон приложения.
 *
 * [com.github.ivankornienko31.stepikclientapplication.presentation.screens.login.LoginScreen] обернут в [com.github.ivankornienko31.stepikclientapplication.presentation.themes.RandomAppTheme], чтобы применить цветовую палитру.
 *
 * @author Иван Корниенко*/
